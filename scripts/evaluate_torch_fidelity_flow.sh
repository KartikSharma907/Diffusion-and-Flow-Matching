...
# Defaults
METHOD="flow_matching" # (right now you only have ddpm but you will be implementing more methods as hw progresses)
CHECKPOINT="/edrive1/kartiksh/cmu-10799-diffusion/logs/flow_matching_20260201_034445/checkpoints/flow_matching_final.pt"
