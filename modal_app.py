...
image = (
    ...
    .add_local_dir(".", "/root", ignore=[".git", ".venv*", "venv", "__pycache__", "logs", "checkpoints", "*.md", "docs", "environments", "notebooks", "data"])
)
...
def _train_impl(
    ...
    #     config_path = f"configs/{method}.yaml"
    # else:
    #     config_path = f"{config_path}"
    #     config_tag = os.path.splitext(os.path.basename(config_path))[0]
    config_path = "/root/configs/ddpm_v2_modal.yaml"
